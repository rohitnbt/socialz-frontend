      ...
      <div className="page-body">
        <div className="profile-header">
          <div className="banner-box">
            <img
              src="https://demourls.xyz/Pulse-development/img/Maskgroup-new.png"
              alt=""
            />
          </div>
          <div className="profile-box-outer">
            <div className="profile-box">
              ...
              <div className="content">
                <a href="#">
                  <h3>Title</h3>
                  <Verify accountType={"accountType"} />
                </a>
                <span>@title</span>
              </div>
            </div>
          ...
          <p className="bio">
            ...
            architecto? Quia pariatur ipsa laboriosam tempora quam. Molestiae
            tenetur nobis vitae perferendis accusamus doloremque temporibus id!
          </p>
