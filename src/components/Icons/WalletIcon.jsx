...
export const WalletIcon = ({ currentPath }) => {
  return (
    <>
      {currentPath === "/wallet" ? (
        <svg
        ...
        >
          ...
          />
          <path
            d="M17.7499 7.05C17.5099 7.01 17.2599 7.00001 16.9999 7.00001H6.99994C6.71994 7.00001 6.44994 7.02001 6.18994 7.06001C6.32994 6.78001 6.52994 6.52001 6.76994 6.28001L10.0199 3.02C11.3899 1.66 13.6099 1.66 14.9799 3.02L16.7299 4.79002C17.3699 5.42002 17.7099 6.22 17.7499 7.05Z"
            fill="black"
          />
          <path
